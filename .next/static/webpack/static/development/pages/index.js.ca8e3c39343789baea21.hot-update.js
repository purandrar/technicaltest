    ...
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 2:
          res = _context.sent;
          _context.next = 5;
          return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(res.json().articles);

        case 5:
          data = _context.sent;
          console.log(data);
          console.log("Show data fetched. Count: ".concat(datalength));
...
//# sourceMappingURL=index.js.ca8e3c39343789baea21.hot-update.js.map